...
Status: **phase 0 done**, released as `@zweiundeins/cashctrl-ts-sdk@0.3.0`.
Phase 1 in progress.
...
| 1 | Skeleton + read tools + `format.ts` + policy/deny list | the bulk of the value; safe against production |
